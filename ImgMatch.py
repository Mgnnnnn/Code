...
if __name__ == '__main__':
    ...
    ImgListNow = ReadSingleNode('/home/kou-ikeda/catkin_ws/src/project_pro/DataCornerTest/1Corner/img/')
    ImgListBefore = ReadSingleNode('/home/kou-ikeda/catkin_ws/src/project_pro/DataCornerTest/8Corner/img/')
    
    print(len(ImgListNow), ImgListNow[0].shape)

    similar = GetSimilarity(ImgListNow, ImgListBefore)
